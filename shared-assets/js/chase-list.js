...
import { formatCurrency, quoteStatusBadge } from './utils.js';
...
export function renderChaseList(attentionQuotes, overdueCount, dueTodayCount) {
  ...
  attentionQuotes.forEach((quote) => {
    ...
    actions.appendChild(create('a', { text: 'Open quote record', attrs: { href: '#quotes' }, dataset: { tab: 'quotes', quoteOpen: quote.id } }));
